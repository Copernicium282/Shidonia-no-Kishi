...
Rectangle {
    ...
    id: root; width: Screen.width; height: Screen.height; color: "#0a0a0a"

    property int sessionIndex: (sessionModel && sessionModel.lastIndex >= 0) ? sessionModel.lastIndex : 0
    property int userIndex: userModel.lastIndex >= 0 ? userModel.lastIndex : 0
    property real ui: 0

    readonly property color signTeal: "#cc1515"
    readonly property color signPink: "#cc1515"
    readonly property color winAmber: "#cc1515"
    readonly property color textWhite: "#ffffff"
    readonly property real timePix: 1.2
    ...
    Repeater {
        ...
        delegate: Item {
            ...
            Rectangle { anchors.fill: parent; gradient: Gradient { GradientStop { position: 0.0; color: "transparent" } GradientStop { position: 1.0; color: "#80cc1515" } } }
            SequentialAnimation {
    ...
    Column {
        ...
        Row {
            spacing: 20 * s
            Item {
                width: hT.implicitWidth * root.timePix; height: hT.implicitHeight * root.timePix
                Text {
                    id: hT; text: Qt.formatTime(new Date(), "HH")
                    color: "white"; font.family: pf.name; font.pixelSize: 100 * s / root.timePix; font.letterSpacing: -5 * s / root.timePix
                    scale: root.timePix; transformOrigin: Item.TopLeft
            ...
            Item {
                width: mT.implicitWidth * root.timePix; height: mT.implicitHeight * root.timePix
                Text {
                    id: mT; text: Qt.formatTime(new Date(), "mm")
                    color: root.signTeal; font.family: pf.name; font.pixelSize: 100 * s / root.timePix; font.letterSpacing: -5 * s / root.timePix
                    scale: root.timePix; transformOrigin: Item.TopLeft
                    layer.enabled: true; layer.smooth: false
    ...
    Column {
        ...
        Text { id: err; text: ""; color: "#cc1515"; anchors.horizontalCenter: parent.horizontalCenter; font.family: pf.name; font.pixelSize: 12 * s }
    }
